...
myApp.factory('groupsInPost', function($resource) {
  return $resource('https://gentle-chamber-9551.herokuapp.com/api/posts/:id', { id: '@_id' }, {
    update: {
...
myApp.factory('getPosts', function($resource) {
  return $resource('https://gentle-chamber-9551.herokuapp.com/api/posts/', {
    update: {
      method: 'PUT' // this method issues a PUT request
    }
  });
...
function($scope, $http, $timeout, $q, $log, $filter, $mdDialog, $mdMedia, groupsInPost, getPosts, $mdToast) {
	...
	$scope.getPostsFromSUser = function(user_id) {
		...
		$http.get('https://gentle-chamber-9551.herokuapp.com/api/users/'+user_id+'/posts').success(function(response){
			$scope.thisUsersPosts = response;
		});
		$http.get('https://gentle-chamber-9551.herokuapp.com/api/users/'+user_id).success(function(response){
	...
	$scope.getPostsInGroup = function(group_id) {
		...
		$http.get('https://gentle-chamber-9551.herokuapp.com/api/groups/'+group_id+'/posts').success(function(response) {
	...
	var refreshSinglePost = function(post_id){
		$http.get('https://gentle-chamber-9551.herokuapp.com/api/posts/' + post_id).success(function(response) {
			
			$scope.post = response;
		});
	}
	var refreshGroup = function(){
		$http.get('https://gentle-chamber-9551.herokuapp.com/api/groups').success(function(response) {
	...
	var refreshSingleGroup = function(group_id){
		$http.get('https://gentle-chamber-9551.herokuapp.com/api/groups/' + group_id).success(function(response) {
	...
	var favorite = function(id) {
		...
		console.log("hello?")
		$http.put('https://gentle-chamber-9551.herokuapp.com/api/posts/' + $scope.post.id, $scope.post).success(function(response) {
	...
	$scope.addUser = function() {
		...
		$http.user('https://gentle-chamber-9551.herokuapp.com/api/users', $scope.user).success(function(response){
			refreshuser();
			//$scope.user = {url: parenturl}
		});
	...
	$scope.removeUser = function(id) {
		console.log(id);
		$http.delete('https://gentle-chamber-9551.herokuapp.com/api/users/' + id).success(function(response) {
			//refreshuser();
		});
	...
	$scope.editUser = function(id){
		console.log(id);
		$http.get('https://gentle-chamber-9551.herokuapp.com/api/users/' + id).success(function(response) {
			$scope.user = response;
		});
	};
	...
	$scope.updateUser = function() {
		...
		$http.put('https://gentle-chamber-9551.herokuapp.com/api/users/' + $scope.user._id, $scope.post).success(function(response) {
			refreshUser();
		});
	};
...
/* ================================ */
    ...
    function loadAll() {
      ...
      $http.get('https://gentle-chamber-9551.herokuapp.com/api/groups').then(function(results) { return results.data; console.log(results.data); });
	...
	$scope.addGroup = function(groupName) {
		...
		$http.post('https://gentle-chamber-9551.herokuapp.com/api/groups', $scope.group).success(function(response){
			refreshGroup();
	...
	$scope.removeGroup = function(id) {
		console.log(id);
		$http.delete('https://gentle-chamber-9551.herokuapp.com/api/groups/' + id).success(function(response) {
			refreshGroup();
		});
	};
	$scope.edit = function(id){
		console.log(id);
		$http.get('https://gentle-chamber-9551.herokuapp.com/api/groups/' + id).success(function(response) {
			$scope.group = response;
		});
	};
	...
	$scope.update = function() {
		...
		$http.put('https://gentle-chamber-9551.herokuapp.com/api/groups/' + $scope.group._id, $scope.group).success(function(response) {
			refreshGroup();
		});
	};
}]);
